...
#SBATCH --output=/sharedscratch/br61/thesis/MVA_SegMamba/logs/4_exp_%j.out
#SBATCH --error=/sharedscratch/br61/thesis/MVA_SegMamba/logs/4_exp_%j.err

APPTAINER=/software/apptainer/bin/apptainer

########## host-side paths you MAY tweak ######################
REPO=/sharedscratch/br61/thesis/MVA_SegMamba
TRAIN_DIR=/sharedscratch/br61/thesis/data/FedBCa_clean/center4_for_center4_processed
TEST_DIR=/sharedscratch/br61/thesis/data/FedBCa_clean/center4_for_center4_processed
GT_DIR=/sharedscratch/br61/thesis/data/FedBCa_clean/center4_raw
...
# sbatch --export=ALL,SEED=42 center4_internal_experiment.sh
