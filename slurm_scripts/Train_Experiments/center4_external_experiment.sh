...
#SBATCH --output=/sharedscratch/br61/thesis/MVA_SegMamba/logs/4_ex_exp_%j.out
#SBATCH --error=/sharedscratch/br61/thesis/MVA_SegMamba/logs/4_ex_exp_%j.err

APPTAINER=/software/apptainer/bin/apptainer

########## host-side paths you MAY tweak ######################
REPO=/sharedscratch/br61/thesis/MVA_SegMamba
TRAIN_DIR=/sharedscratch/br61/thesis/data/FedBCa_clean/center4_for_all_processed
TEST_DIR=/sharedscratch/br61/thesis/data/FedBCa_clean/centres_1-2-3_processed
...
# sbatch center4_external_experiment.sh
