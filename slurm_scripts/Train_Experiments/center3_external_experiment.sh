...
#SBATCH --output=/sharedscratch/br61/thesis/MVA_SegMamba/logs/3_ex_exp_%j.out
#SBATCH --error=/sharedscratch/br61/thesis/MVA_SegMamba/logs/3_ex_exp_%j.err

APPTAINER=/software/apptainer/bin/apptainer

########## host-side paths you MAY tweak ######################
REPO=/sharedscratch/br61/thesis/MVA_SegMamba
TRAIN_DIR=/sharedscratch/br61/thesis/data/FedBCa_clean/center3_for_all_processed
TEST_DIR=/sharedscratch/br61/thesis/data/FedBCa_clean/centres_1-2-4_processed
GT_DIR=/sharedscratch/br61/thesis/data/FedBCa_clean/all_centers
...
# sbatch center3_external_experiment.sh
...
"$APPTAINER" exec --nv --cleanenv \
    ...
    python /workspace/plot_metrics.py \
          ...
          --metrics_npy /workspace/experiment/metrics/all.npy \
