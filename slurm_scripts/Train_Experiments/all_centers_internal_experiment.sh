...
#SBATCH --output=/sharedscratch/br61/thesis/MVA_SegMamba/logs/all_exp_%j.out
#SBATCH --error=/sharedscratch/br61/thesis/MVA_SegMamba/logs/all_exp_%j.err

APPTAINER=/software/apptainer/bin/apptainer

########## host-side paths you MAY tweak ######################
REPO=/sharedscratch/br61/thesis/MVA_SegMamba
TRAIN_DIR=/sharedscratch/br61/thesis/data/FedBCa_clean/all_centers_external_processed
TEST_DIR=/sharedscratch/br61/thesis/data/FedBCa_clean/all_centers_external_processed
...
# sbatch --export=ALL,SEED=1 all_centers_internal_experiment.sh
