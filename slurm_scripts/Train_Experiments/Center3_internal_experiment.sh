...
#SBATCH --output=/sharedscratch/br61/thesis/MVA_SegMamba/logs/3exp_%j.out
#SBATCH --error=/sharedscratch/br61/thesis/MVA_SegMamba/logs/3exp_%j.err

APPTAINER=/software/apptainer/bin/apptainer

########## host-side paths you MAY tweak ######################
REPO=/sharedscratch/br61/thesis/MVA_SegMamba
TRAIN_DIR=/sharedscratch/br61/thesis/data/FedBCa_clean/center3_for_center3_processed
TEST_DIR=/sharedscratch/br61/thesis/data/FedBCa_clean/center3_for_center3_processed
GT_DIR=/sharedscratch/br61/thesis/data/FedBCa_clean/center3_raw
...
# sbatch --export=ALL,SEED=42 center3_internal_experiment.sh
