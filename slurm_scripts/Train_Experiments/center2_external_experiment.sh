...
#SBATCH --output=/sharedscratch/br61/thesis/MVA_SegMamba/logs/2_ex_exp_%j.out
#SBATCH --error=/sharedscratch/br61/thesis/MVA_SegMamba/logs/2_ex_exp_%j.err

APPTAINER=/software/apptainer/bin/apptainer

########## host-side paths you MAY tweak ######################
REPO=/sharedscratch/br61/thesis/MVA_SegMamba
TRAIN_DIR=/sharedscratch/br61/thesis/data/FedBCa_clean/center2_for_all_processed
TEST_DIR=/sharedscratch/br61/thesis/data/FedBCa_clean/centres_1-3-4_processed
...
# sbatch center2_external_experiment.sh
