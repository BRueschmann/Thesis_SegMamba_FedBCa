...
#SBATCH --output=/sharedscratch/br61/thesis/MVA_SegMamba/logs/all_center_process_%j.out
#SBATCH --error=/sharedscratch/br61/thesis/MVA_SegMamba/logs/all_center_process_%j.err
...
# ---------- Average center settings ----------
CENTER_IN=/workspace/data/FedBCa_clean/all_centers
CENTER_OUT=/workspace/data/FedBCa_clean/all_centers_external_processed
Z=3.6
Y=0.8
X=0.8
