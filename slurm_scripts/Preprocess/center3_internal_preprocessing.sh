...
#SBATCH --output=/sharedscratch/br61/thesis/MVA_SegMamba/logs/center3_process_%j.out
#SBATCH --error=/sharedscratch/br61/thesis/MVA_SegMamba/logs/center3_process_%j.err
...
CENTER_OUT=/workspace/data/FedBCa_clean/center3_for_center3_processed
Z=4.5
Y=0.75
X=1.0
