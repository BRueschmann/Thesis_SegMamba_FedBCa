...
#SBATCH --output=/sharedscratch/br61/thesis/MVA_SegMamba/logs/center2_process_%j.out
#SBATCH --error=/sharedscratch/br61/thesis/MVA_SegMamba/logs/center2_process_%j.err
...
CENTER_OUT=/workspace/data/FedBCa_clean/center2_for_center2_processed
Z=3.0
Y=0.6
X=0.74
