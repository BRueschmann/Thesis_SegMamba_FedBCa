...
#SBATCH --output=/sharedscratch/br61/thesis/MVA_SegMamba/logs/center4_process_%j.out
#SBATCH --error=/sharedscratch/br61/thesis/MVA_SegMamba/logs/center4_process_%j.err
...
CENTER_OUT=/workspace/data/FedBCa_clean/center4_for_center4_processed
Z=5.0
Y=0.88
X=0.88
