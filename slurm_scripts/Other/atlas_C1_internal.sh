#!/bin/bash
#SBATCH --job-name=atlas_C1_int
#SBATCH --partition=small-long
#SBATCH --time=01:00:00
#SBATCH --mem=24G
#SBATCH --cpus-per-task=4
#SBATCH --chdir=/sharedscratch/br61/thesis/slurm_scripts
#SBATCH --output=/sharedscratch/br61/thesis/MVA_SegMamba/logs/atlas_C1_int_%j.out
#SBATCH --error=/sharedscratch/br61/thesis/MVA_SegMamba/logs/atlas_C1_int_%j.err
...
EXP_ROOT=/sharedscratch/br61/thesis/Experiments/Experiment_1556605_C1_internal_S42
PRED_DIR=${EXP_ROOT}/predictions/test
RESULTS_NP=${EXP_ROOT}/metrics/test.npy
